...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'sub_category','product_name', 'price',
                  'product_type', 'product_images', 'get_avg_rating', 'get_count_people']
...
class ProductDetailSerializer(serializers.ModelSerializer):
    product_images = ProductImageSerializer(many=True, read_only=True)
    sub_category = SubCategoryNameSerializer()
    reviews = ReviewSerializer(many=True, read_only=True)

    class Meta:
        model = Product
        fields = ['product_name', 'sub_category', 'price', 'product_images', 'video',
